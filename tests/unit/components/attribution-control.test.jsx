...
describe('AttributionControl Component', () => {
  ...
  test('supports multiple controls with different positions', () => {
    ...
    mockMapLib.AttributionControl.mockImplementationOnce(function () {
      return firstControlInstance
    }).mockImplementationOnce(function () {
      return secondControlInstance
    })
  ...
  describe('attribution content rewrite', () => {
    ...
    test('warns when .maplibregl-ctrl-attrib-inner is missing', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining('maplibregl-ctrl-attrib-inner'))
      warnSpy.mockRestore()
    })
