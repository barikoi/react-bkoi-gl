...
<p align="center">
  <!-- Zero-dependency badges: self-contained SVGs committed in the repo — no
       external service (no rate limits), no CI, render on private repos. Regenerated
       by `npm test`, `npm run coverage`, and `npm run build` (scripts/make-badges.mjs). -->
  <img src="coverage-badge.svg" alt="test coverage">
  <img src="tests-badge.svg" alt="tests">
  <img src="size-badge.svg" alt="bundle size">
  ...
  <img src="maplibre-badge.svg" alt="MapLibre engine version">
  <img src="https://img.shields.io/badge/Next.js-15%20%7C%2016-black?logo=nextdotjs" alt="Next.js 15 | 16">
  <img src="https://img.shields.io/badge/Vite-5%20%7C%206%20%7C%207-646CFF?logo=vite&logoColor=white" alt="Vite 5 | 6 | 7">
  <img src="https://img.shields.io/badge/CRA-5-09D3AC?logo=react&logoColor=white" alt="CRA 5">
  <img src="https://img.shields.io/badge/WebGL-2-orange?logo=webgl" alt="WebGL2">
  <img src="https://img.shields.io/badge/npm-%E2%9C%93-CB3837?logo=npm&logoColor=white" alt="npm supported">
  <img src="https://img.shields.io/badge/yarn%20classic-%E2%9C%93-2C8EBB?logo=yarn&logoColor=white" alt="yarn classic supported">
  <img src="https://img.shields.io/badge/pnpm-%E2%9C%93-F69220?logo=pnpm&logoColor=white" alt="pnpm supported">
  <img src="https://img.shields.io/badge/bun-%E2%9C%93-000?logo=bun" alt="bun supported">
  <!-- GitHub badges need a public repo — the source is private (npm package only).
       Uncomment when the repo goes public:
  <a href="https://github.com/barikoi/react-bkoi-gl"><img src="https://img.shields.io/github/stars/barikoi/react-bkoi-gl?style=social" alt="GitHub stars"></a>
  <a href="https://github.com/barikoi/react-bkoi-gl/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs welcome"></a>
  -->
</p>
...
- High-performance map rendering using WebGL2 (maplibre-gl v6) — installed and configured automatically, no direct engine import needed
- Declarative react-map-gl-style API: `Map`, `Marker`, `Popup`, `Source`, `Layer`, `useMap`, `useControl`
- **Drawing tools** built in — `DrawControl` for polygons, lines, and points with a toolbar (no separate draw package to wire up)
- **Minimap control** — a live overview mini-map for navigation
- **Globe and Terrain controls** — first-class components to toggle globe projection and 3D terrain
- Full control set: Navigation, Scale, Geolocate, Fullscreen, Attribution, Logo
- Support for GeoJSON, vector tiles, raster, image, video, and canvas sources
- Works out of the box with Next.js 15/16, Vite 5/6/7, CRA, and all major package managers
...
| Package managers | npm, yarn classic (1.x), pnpm, bun (hoisted `node_modules` layouts). Yarn Berry Plug'n'Play is not supported — use `nodeLinker: node-modules`. |
...
| **Package managers** | npm, yarn classic (1.x), pnpm, bun | None (Yarn Berry Plug'n'Play is not supported — use `nodeLinker: node-modules`) |
        ...
        data={{
          ...
          features: [
            ...
            },
            {
              ...
              geometry: { type: 'Point', coordinates: [90.40, 23.83] }
            }
          ]
        }}
      >
...
```tsx
import { Map, useControl, IControl } from 'react-bkoi-gl';
import "react-bkoi-gl/styles";
